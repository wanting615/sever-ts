...
let OrderController = class OrderController {
    ...
    async getOrderDetail(ctx) {
        ...
        try {
            const data = await order_1.OrderModel.getOrderById(params.orderId, Number(params.user_id));
    ...
    async createOrder(ctx) {
        ...
        try {
            ...
            const orderId = (0, formater_1.createOrderId)(id, Number(ctx.request.body.user_id));
